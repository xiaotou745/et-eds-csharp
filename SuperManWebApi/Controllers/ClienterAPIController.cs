...
namespace SuperManWebApi.Controllers
{
    public class ClienterAPIController : ApiController
    {
        ...
        public ResultModel<UploadIconModel> PostAudit_C()
        {
            ...
            //手持照片
            ImgInfo handImg = ih.UploadImg(fileHand, ParseHelper.ToInt(strUserId, 0), UserType.Clienter);
            //身份证照片
            ImgInfo sfhImg = ih.UploadImg(file, ParseHelper.ToInt(strUserId, 0), UserType.Clienter);
            ...
            var relativePath = Path.Combine(CustomerIconUploader.Instance.GetPhysicalPath(0, UserType.Clienter), sfhImg.FileName).ToForwardSlashPath();
