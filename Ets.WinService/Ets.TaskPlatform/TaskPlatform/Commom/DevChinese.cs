    ...
    public class XtraEditors_CN : Localizer
    {
        ...
        public override string GetLocalizedString(StringId id)
        {
            switch (id)
            {
                ...
                case StringId.PictureEditOpenFileFilter: return "位 图文件(*.bmp)|*.bmp|GIF动画 (*.gif)|*.gif|JPEG(*.jpg;*.jpeg)|*.jpg;*.jpeg|ICO(*.ico)|*.ico|所有图片文 件|*.bmp;*.gif;*.jpeg;*.jpg;*.ico|所有文件(*.*)|*.*";
                ...
                case StringId.MaskBoxValidateError: return "输入数值不完整. 是否须要修改? 是 - 回到编辑模式以修改数值. 否 - 保持原来数值. 取消 - 恢复原来数值. ";
    ...
    public class XtraPrinting_CN : PreviewLocalizer
    {
        ...
        public override string GetLocalizedString(PreviewStringId id)
        {
            switch (id)
            {
                ...
                case PreviewStringId.SB_PageOfPages: return "页码:";
