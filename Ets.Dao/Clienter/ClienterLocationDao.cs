...
join clienter (Nolock) c on cl.ClienterId=c.Id ", DateTime.Now.AddMinutes(-ParseHelper.ToInt(int.Parse(GlobalConfigDao.GlobalConfigGet(0).SearchClienterLocationTimeInterval), 0)));
