...
public class MyMissionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.OriginalOrderNo = (TextView) convertView.findViewById(R.id.originalOrderNo);
        ...
        holder.OriginalOrderNo.setText(mb.getOriginalOrderNo());
    ...
    private class Holder {
        ...
        private TextView OriginalOrderNo;
    }
