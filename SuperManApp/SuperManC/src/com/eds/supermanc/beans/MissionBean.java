...
public class MissionBean implements Serializable {
    ...
    public String toString() {
        return "MissionBean [Status=" + Status + ", Message=" + Message + ", Result=" + Result + "]";
    }
    ...
    public class Mission implements Serializable {
        ...
        private String OriginalOrderNo;// 第三方订单号
        ...
        @Override
        public String toString() {
            return "Mission [userId=" + userId + ", OrderNo=" + OrderNo + ", income=" + income + ", distance="
                    + distance + ", pubDate=" + pubDate + ", businessName=" + businessName + ", pickUpCity="
                    + pickUpCity + ", pickUpAddress=" + pickUpAddress + ", businessPhone=" + businessPhone
                    + ", receviceName=" + receviceName + ", receviceCity=" + receviceCity + ", receviceAddress="
                    + receviceAddress + ", recevicePhone=" + recevicePhone + ", Amount=" + Amount + ", IsPay=" + IsPay
                    + ", Remark=" + Remark + ", Status=" + Status + ", distanceB2R=" + distanceB2R
                    + ",OriginalOrderNo=" + OriginalOrderNo + "]";
        }
