...
public void onResponse(String response, int requestCode) {	
		try {
			...
			if(status==0){
				...
				todyAmount.setText(obj.getString("todayPublishAmount")+"元");
				todyFinshCount.setText(""+obj.getInt("todayDone")+"单");
				todyFinshAmount.setText(obj.getString("todayDoneAmount")+"元");
				monthCount.setText(""+obj.getInt("monthPublish")+"单");
				monthAmount.setText(obj.getString("monthPublishAmount")+"元");
				monthFinshCount.setText(""+obj.getInt("monthDone")+"单");
				monthFinshAmount.setText(obj.getString("monthDoneAmount")+"元");
