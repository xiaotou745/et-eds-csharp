...
public class AddAdressActivity extends BaseActionBarActivity implements
		OnClickListener, OnGetGeoCoderResultListener, HTTPListener {
	...
	private void initDate() {
		...
		address = new Address();
		address.city = city;
		adapter1 = new CityAdapter(this,
				new CityWorker(this).getAreaByCity(city.getPcode()));
	...
	public void onClick(View arg0) {
		...
		case R.id.btn_mark:
			...
			intent.putExtra("Adress",
					adapter1.getItem((int) spinner1.getSelectedItemId())
							.toString() + etDatileAdr.getText().toString());
		...
		case R.id.btn_save:
			...
			StringBuilder buffer = new StringBuilder(adapter1.getItem(
					(int) spinner1.getSelectedItemId()).getName());
			...
			mSearch.geocode(new GeoCodeOption().city(city.getName()).address(
					buffer.toString()));
			break;
		}
	...
	public void onGetGeoCodeResult(GeoCodeResult arg0) {
		...
		LatLng ptCenter = new LatLng(arg0.getLocation().latitude,
				...
				.setPositiveButton("确定",
						new android.content.DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog,
								...
								parms.put("landLine", ""
										+ tel.getText().toString());
								parms.put("districtName",
										address.area.getName());
								parms.put("districtId",
										"" + address.area.getPcode());
								...
								util.post(parms, Constants.URL_ADD_ADDRESS,
										AddAdressActivity.this, 0);
							}
