    ...
    Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            if (user == null || user.id == 0) {
                ...
                String strPwd = MD5.md5(user.password);
                map.put("passWord", strPwd);
                dialog = ProgressDialog.show(FirstActivity.this, "提示", "正在登录中", false, false);
                dialog.show();
                volleyUtil.post(map, Constants.URL_LOGIN, FirstActivity.this, 0);
