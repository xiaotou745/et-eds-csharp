    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_login).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog = ProgressDialog.show(LoginActivity.this, "提示", "正在登录中", false, false);
                ...
                /*
                 * User user = new User(); user.id = 5; user.password = "8888"; user.userPhone="15558888"; Address
                 * address = new Address(); CityMode cityMode = new CityMode(); cityMode.setName("北京"); address.city =
                 * cityMode; user.address = address; UserUtil.saveUser(LoginActivity.this,user); Intent intent = new
                 * Intent(LoginActivity.this, HomeActivity.class); startActivity(intent);
                 */
