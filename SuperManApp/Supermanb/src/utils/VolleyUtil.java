...
public class VolleyUtil {
	...
	public void post(final Map<String, String> parms,String url,
			final HTTPListener listener, final int requestCode) {
	...
	public void get(final Map<String, String> params,String url,
			final HTTPListener listener, final int requestCode){
		url = Constants.host+url;
