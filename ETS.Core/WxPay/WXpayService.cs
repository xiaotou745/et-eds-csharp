...
namespace ETS.WxPay
{
    public class WXpayService
    {
        ...
        public WXpayService(string spbill_create_ip, string out_trade_no, string body, string wx_nonceStr, string total_fee)
        {
            setParameter("appid", Config.AppId);
            setParameter("trade_type", "NATIVE");   ////NATIVE
