...
namespace ETS.Pay.YeePay
{
    ...
    public class Register
    {
        ...
        /// <returns></returns>
        public RegisterReturnModel RegSubaccount(YeeRegisterParameter model,out HttpModel httpModel)
        {
            //商户编号   
            ...
            return RegSubaccount(customernumber, hmackey, model.RequestId, model.BindMobile,
                ...
                model.AccountName, model.BankAccountType, model.BankProvince, model.BankCity, model.ManualSettle,ref model,out httpModel);
        }
        /// <summary>
        /// 子账户注册(out 参数重载)
        /// ruhuaxiao
        ...
        public RegisterReturnModel RegSubaccount(string customernumber, string hmackey, string requestid,
            ...
            string idcard, string businesslicence, string legalperson, string minsettleamount,
            string riskreserveday, string bankaccountnumber, string bankname, string accountname,
            string bankaccounttype, string bankprovince, string bankcity, string manualsettle, ref YeeRegisterParameter model,out HttpModel httpmodel)
        {
            try
            {
                var js = new JavaScriptSerializer();
                ...
                httpmodel = new HttpModel
                {
                    ...
                    ReuqestMethod = "ETS.Pay.YeePay.Register.RegSubaccount",
                    Status = 1,
                    Remark = "易宝子账户注册"
                };
                return returnModel;
