...
namespace SuperMan.Controllers
{
    ...
    public class OrderController : BaseController
    {
        ...
        public ActionResult Order()
        {
            ...
            var criteria = new Ets.Model.ParameterModel.Order.OrderSearchCriteria() { orderStatus = -1, PagingRequest = new Ets.Model.Common.NewPagingResult(1, 15), GroupId = SuperMan.App_Start.UserContext.Current.GroupId };
