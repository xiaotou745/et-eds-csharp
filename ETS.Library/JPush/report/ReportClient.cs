...
using JsonTool = ETS.Library.JPush.util.JsonTool;
...
namespace ETS.Library.JPush.report
{
    class ReportClient:BaseHttpClient
    {
        ...
        public  ETS.Library.JPush.report.UsersResult    getUsers(TimeUnit timeUnit, String start, int duration)
        {
            ...
            return ETS.Library.JPush.report.UsersResult.fromResponse(response);
        }
