...
using ETS.Library.JPush.common;
using ETS.Library.JPush.common.resp;
using ETS.Library.JPush.device;
using ETS.Library.JPush.push;
using ETS.Library.JPush.report;
using ETS.Library.JPush.util;
using AliasDeviceListResult = ETS.Library.JPush.device.AliasDeviceListResult;
using BooleanResult = ETS.Library.JPush.common.resp.BooleanResult;
using DefaultResult = ETS.Library.JPush.common.resp.DefaultResult;
using MessageResult = ETS.Library.JPush.push.MessageResult;
using MessagesResult = ETS.Library.JPush.report.MessagesResult;
using PushPayload = ETS.Library.JPush.push.mode.PushPayload;
using ReceivedResult = ETS.Library.JPush.report.ReceivedResult;
using TagAliasResult = ETS.Library.JPush.device.TagAliasResult;
using TagListResult = ETS.Library.JPush.device.TagListResult;
using TimeUnit = ETS.Library.JPush.common.TimeUnit;
using UsersResult = ETS.Library.JPush.report.UsersResult;

namespace ETS.Library.JPush
{
    /// <summary>
    ...
    public class JPushClient
    {
        ...
        /// <exception cref="common.APIRequestException">包含http错误码：如401,404等，错误信息，JPush returen code和JPush returen mssage</exception>
        /// <exception cref="common.resp.APIConnectionException">包含错误的信息</exception>
