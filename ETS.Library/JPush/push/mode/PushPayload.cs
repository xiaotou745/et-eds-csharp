...
using AudienceConverter = ETS.Library.JPush.common.AudienceConverter;
using PlatformConverter = ETS.Library.JPush.common.PlatformConverter;

namespace ETS.Library.JPush.push.mode
{
