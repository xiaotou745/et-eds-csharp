...
using APIConnectionException = ETS.Library.JPush.common.resp.APIConnectionException;
...
namespace ETS.Library.JPush.common
{
    class BaseHttpClient
    {
        ...
        public ETS.Library.JPush.common.ResponseWrapper sendPost(String url, String auth, String reqParams) 
        { 
            return this.sendRequest( "POST",  url,  auth, reqParams);        
        }
        public ETS.Library.JPush.common.ResponseWrapper sendDelete(String url, String auth, String reqParams)
        {
            return this.sendRequest("DELETE", url, auth, reqParams);
        }
        public ETS.Library.JPush.common.ResponseWrapper sendGet(String url, String auth, String reqParams)
        {
         ...
         * auth   可选
         */
        public ETS.Library.JPush.common.ResponseWrapper sendRequest(String method, String url, String auth,String reqParams)
        {
            ...
            ETS.Library.JPush.common.ResponseWrapper result = new ETS.Library.JPush.common.ResponseWrapper();
